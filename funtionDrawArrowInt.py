...
def draw_Arrow_Int(net, separador, indice, aux_index):
    # Arc 2
    # Son 1.5
    arc = ET.SubElement(net, 'arc') 
    arc.set('id', str(separador[aux_index]) + ' to T' + str(indice))
    arc.set('source', str(separador[aux_index]))
    arc.set('target', 'T' + str(indice))
