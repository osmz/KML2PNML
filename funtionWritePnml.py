...
def write_Pnml(list_Goal, auxParaFor):
    ...
    starting_Position_X_Place = 250.0
    starting_Position_Y_Place = 190.0  

    # For to create all elements
    for index in range(auxParaFor):
        ...
        starting_Position_X_Place += 50
        starting_Position_Y_Place += 50
